...
# Sourced before the first timestamp below, so even the run's start stamp goes
# through the single owner of "which python3 to run".
...
family_for_basename() {
  case "$1" in
    ...
    fm-spawn-dispatch-profile.test.sh|fm-spawn-meta-spawned.test.sh|\
