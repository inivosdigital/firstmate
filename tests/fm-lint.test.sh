...
test_source_graph_boundaries_keep_every_owner() {
  ...
  [ "$production_context_tests" = 'fm-backend-herdr.test.sh|fm-daemon.test.sh|fm-memcap.test.sh|fm-pending-reply.test.sh|fm-secondmate-sync.test.sh|fm-tmp-lib.test.sh|' ] \
