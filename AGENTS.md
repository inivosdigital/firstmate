...
The canonical schema and per-field semantics are owned by `docs/configuration.md` ("Crew dispatch profiles"), including the optional `ultracode`/`ultracode_role` profile fields; read them there before writing or editing the file.
