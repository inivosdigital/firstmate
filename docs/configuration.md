...
`use.ultracode` and `use.ultracode_role` are optional; AGENTS.md section 4 owns what setting `ultracode: true` means operationally and the mechanical guard that backs it.
