...
The canonical schema, array `use` form, `select` strategies, optional `ultracode`/`ultracode_role` profile fields, and quota-balanced fallback contract live in `AGENTS.md` section 4.
